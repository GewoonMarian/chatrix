  ...
  return (
    selectedUser && (
      ...
      >
        ...
        <button className="absolute bottom-5 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-400 to-blue-500 text-white border-none text-sm font-light py-2 px-20 rounded-full cursor-pointer">
          LogOut
        </button>
      </div>
    )
